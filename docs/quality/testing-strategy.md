...
3. Current coverage: interaction state transitions, key/switch link behavior, occupancy/blocking invariants, baseline line-of-sight/occlusion checks, directional hearing invariants, and fog-of-war visible/explored state transitions.
